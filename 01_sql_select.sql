...
SELECT Name AS 'Country name', IndepYear AS 'Independence year' FROM Country WHERE IndepYear < 0;

-- 16: Get the countries that have no recorded independence year and a population above 1000000

SELECT Name AS 'Country name', IndepYear AS 'Independence year', Population
 FROM Country 
...
SELECT Name AS 'Country name', SurfaceArea AS 'Surface Area', LifeExpectancy
FROM Country 
